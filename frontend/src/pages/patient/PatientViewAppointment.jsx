...
const PatientViewAppointment = () => {
  ...
  if (loading)
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-50 via-white to-cyan-100 px-4">
          ...
          <div className="w-full px-4 sm:px-6 lg:px-0 pt-1 pb-8">
            <div className="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-slate-100">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 border-b border-slate-100 text-sky-600 font-bold px-4 sm:px-6 py-5">
                <div className="mx-auto sm:mx-0 flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full ring-2 ring-sky-200 overflow-hidden bg-white shadow-sm shrink-0">
                ...
                <div
                  className={`self-center sm:self-auto sm:ml-auto flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold ring-1 ${sc.bg} ${sc.color} ${sc.ring}`}
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 border-b border-slate-100 px-4 sm:px-6 py-6">
                <InfoRow
                  label="Date"
                  value={new Date(
              ...
              <div className="px-4 sm:px-6 py-6">
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="rounded-xl bg-slate-50 px-4 py-3 text-sm text-slate-700 ring-1 ring-slate-100 break-words">
                  ...
                  {appointment.notes && (
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="rounded-xl bg-sky-50 px-4 py-3 text-sm text-slate-700 ring-1 ring-sky-100 break-words">
                        {appointment.notes}
                      </p>
                    </div>
                  )}
              ...
              {/* Consultation Link */}
              <div className="border-t border-slate-100 px-4 sm:px-6 py-6">
                <p className="mb-4 text-xs font-semibold uppercase tracking-wide text-slate-400">
                  Consultation Link
                </p>

                <div className="flex flex-col gap-3 rounded-xl bg-sky-50 px-4 sm:px-5 py-4 ring-1 ring-sky-100 overflow-hidden">
                  <div className="flex items-start sm:items-center gap-2 min-w-0">
                    <Icon
                      icon="mdi:link-variant"
                      className="h-4 w-4 shrink-0 text-sky-500 mt-0.5 sm:mt-0"
                    />
                    ...
                    <a
                      ...
                      className="break-all text-sm font-medium text-sky-600 underline underline-offset-2 hover:text-sky-800"
                    >
                  ...
                  <button
                    ...
                    className={`flex w-full sm:w-fit justify-center items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition ${
                      appointment.status === "cancelled" ||
                      appointment.status === "completed"
                ...
                {/* Consultation PDF */}
                {appointment.status === "completed" && (
                  <div className="mt-4 rounded-xl bg-green-50 px-4 sm:px-5 py-4 ring-1 ring-green-100">
                    ...
                    <button
                      ...
                      className="flex w-full sm:w-fit justify-center items-center gap-2 rounded-xl bg-green-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-green-700"
                    >
                      <Icon
                ...
                {/* Message Doctor */}
                <div className="mt-4 flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between rounded-xl bg-slate-50 px-4 sm:px-5 py-4 ring-1 ring-slate-100">
                  ...
                  <button
                    className="flex w-full sm:w-auto justify-center shrink-0 items-center gap-2 rounded-xl border border-sky-200 bg-white px-4 py-2.5 text-sm font-semibold text-sky-600 transition hover:bg-sky-50 hover:border-sky-300"
                ...
                {isCancellable ? (
                  <div className="border-t border-slate-100 px-4 sm:px-6 py-5">
                    {!showConfirm ? (
                      <button
                        ...
                        className="w-full sm:w-fit sm:ml-auto justify-center flex items-center gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-2.5 text-sm font-medium text-red-600 transition hover:bg-red-100 hover:border-red-300"
                      >
                        Cancel Appointment
                      </button>
                    ) : (
                      <div className="flex flex-col gap-3 rounded-xl bg-red-50 px-4 sm:px-5 py-4 ring-1 ring-red-100">
                        <p className="text-sm font-medium text-slate-700">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                          <button
                            ...
                            disabled={cancelling}
                            className="w-full sm:w-auto flex justify-center items-center gap-2 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-red-700 disabled:opacity-60"
                          >
                            {cancelling && (
                          ...
                          <button
                            ...
                            className="w-full sm:w-auto rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-50"
                          >
                            Keep Appointment
                          </button>
                        </div>
                  ...
                  <div className="flex flex-col gap-3 rounded-xl bg-red-50 px-4 sm:px-5 py-4 ring-1 ring-red-100 mt-4">
