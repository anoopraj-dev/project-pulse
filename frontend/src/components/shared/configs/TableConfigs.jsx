...
export const patientAppointmentColumns = [
  ...
  {
    header: "Time",
    render: (appointment) => appointment.timeSlot || formatTime(appointment.appointmentDate),
  },
  {
    header: "Status",
    render: (appointment) => {
...
export const doctorAppointmentColumns = [
  ...
  },
  {
    ...
    render: (appointment) => (
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <span className="font-semibold text-gray-900">{appointment.patient?.name || "-"}</span>
          <span className="text-xs text-gray-500">{appointment.patient?.gender || "-"}</span>
        </div>
      </div>
    ),
  },
  ...
  {
    header: "Time",
    render: (a) => a.timeSlot || formatTime(a.appointmentDate),
  },
  {
    header: "Status",
    render: (appointment) => {
...
export const doctorPaymentColumns = [
  {
    header: "Date",
    render: (item) => formatDate(item.processedAt || item.createdAt),
  },
  {
    header: "Patient",
    render: (item) => (
